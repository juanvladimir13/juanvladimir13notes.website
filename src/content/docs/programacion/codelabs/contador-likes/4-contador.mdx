---
title: '5. Funcion contador'
description: 'Implementación de la lógica del contador en JavaScript: variables de estado, referencias DOM y event listeners de clic.'

head:
  - tag: meta
    attrs:
      property: og:title
      content: '5. Funcion contador'
  - tag: meta
    attrs:
      property: og:description
      content: 'Implementación de la lógica del contador en JavaScript: variables de estado, referencias DOM y event listeners de clic.'
  - tag: meta
    attrs:
      property: og:image
