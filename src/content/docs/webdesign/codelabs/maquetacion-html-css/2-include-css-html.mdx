...
description: 'Aprende las 3 formas de vincular CSS en HTML: estilos en línea, etiqueta style interna y archivos CSS externos con link.'
...
head:
  ...
  - tag: meta
    attrs:
      ...
      content: 'Aprende las 3 formas de vincular CSS en HTML: estilos en línea, etiqueta style interna y archivos CSS externos con link.'
  - tag: meta
    attrs:
      property: og:image
